...
class SearchServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.SearchHadis = channel.unary_unary(
                '/SearchService/SearchHadis',
...
def add_SearchServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SearchHadis': grpc.unary_unary_rpc_method_handler(
                    servicer.SearchHadis,
